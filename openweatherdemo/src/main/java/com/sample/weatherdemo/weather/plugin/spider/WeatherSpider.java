package  com.sample.weatherdemo.weather.plugin.spider;
...
import com.sample.weatherdemo.android.volley.DefaultRetryPolicy;
import com.sample.weatherdemo.android.volley.toolbox.RequestFuture;
import com.sample.weatherdemo.android.volley.toolbox.StringRequest;
import com.sample.weatherdemo.common.util.NetUtil;
...
import com.sample.weatherdemo.weather.plugin.bean.Alerts;
import com.sample.weatherdemo.weather.plugin.bean.Forecast;
import com.sample.weatherdemo.weather.plugin.bean.Index;
...
public class WeatherSpider {
	...
	public static WeatherInfo getWeatherInfo(String postID) throws TaskException {
		...
		try {
			...
			WeatherInfo weatherInfo = WeatherSpider.getWeatherInfo(
					MyApplication.getInstance(), postID, result);
	...
	public static void save2Database(WeatherInfo weatherInfo, String postID,
		...
		if (pubTime != savePubTime) {
			...
			contentValues.put(CityProvider.CityConstants.PUB_TIME, pubTime);
	...
	public static long getPubTime(String postID) {
		Cursor c = MyApplication.getInstance()
				.getContentResolver()
